...
import { signUp } from '../lib/api'
  ...
  return (
    <div className='min-h-screen flex items-center justify-center p-4 sm:p-6 md:p-8 overflow-hidden' data-theme="forest">
        ...
        <div className='hidden lg:flex w-full lg:w-1/2 bg-primary/10 items-center justify-center'>
          <div className='max-w-md p-8'>
            <div className='relative aspect-square max-w-sm mx-auto'>
              <img src='/pic1.svg' alt="language connection illlustration" className='w-full h-full' />
            </div>

            <div className='text-center sapce-y-3 mt-6'>
